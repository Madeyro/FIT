...
*/
    ...
    /* ^^^
     * Ak vyuzijeme operaciu modulo nad cislom mensim ako je QUEUE_SIZE,
     * operacia nam vrati to cislo. Modulo QUEUE_SIZE s QUEUE_SIZE je nula
     * a kedze prvky su cislovane od 0, je posledny prvok QUEUE_SIZE-1.
     * Logicky teda nasledujuci prvok, kt. je zaroven prvym prvkom pola, treda 0
     * vypocitame ako index+1 % QUEUE_SIZE 
     */
}
...
*/
    ...
    /* ^^^
     * Ak je zaciatok fronty zhodny s prvym volnym prvkom 
     * je tato fronta prazdna 
     */
}
...
*/
    ...
    /* ^^^
     * Ak by sme chceli zapisat do prveho volneho, potrebujeme nasledujuci 
     * prazdny. Fronta je plna, ak je tento nasledujuci volny zhodny
     * s prvym prvkom, teda zaciatkom fronty 
     */
}
